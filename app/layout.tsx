...
export const metadata: Metadata = {
  title: "SINA TRADING — Your Goods, Our Priority",
  description:
    "SINA Supplies and Logistics PLC — procurement, logistics, events, property, and staffing for corporate organizations in Ethiopia.",
};
